...
import { getContactsForOrganisation } from 'components/Contact/contact.selector';
...
const CallListContactDropdown = ({ handleSearch, contacts, isFetching, ...other }: PropsT) => {
  return (
    <Dropdown
      loading={isFetching}
