...
import { changeOnMultiMenu } from '../contact.actions';
...
export default compose(
  ...
  withHandlers({
    ...
    onSave: ({ changeOnMultiMenu, fields, overviewType, changeOnMultiMenuRecruitment }) => () => {
      if (overviewType === OverviewTypes.RecruitmentClosed) {
        changeOnMultiMenuRecruitment('update_data_fields', fields, overviewType);
      } else {
