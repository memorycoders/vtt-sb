  ...
  return (
    <Form className={`${css.padded} position-unset`}>
      ...
      <FormPair mini label={_l`Unit`}>
        <UnitDropdown upward={false} className='position-clear' id='CreateCallListUnitDropdơwn' onClick={() => calculatingPositionMenuDropdown('CreateCallListUnitDropdơwn')}  value={form.unit} onChange={handleUnitChange} />
      </FormPair>
      <FormPair mini label={_l`Responsible`}>
        <UserDropdown upward={false} className='position-clear' id='CreateCallListUserDropdơwn' onClick={() => calculatingPositionMenuDropdown('CreateCallListUserDropdơwn')} value={form.responsible} onChange={handleResponsibleChange} />
      </FormPair>
