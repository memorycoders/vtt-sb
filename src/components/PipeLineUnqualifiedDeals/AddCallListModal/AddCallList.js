          ...
          <div
            className={
              ...
              overviewType === OverviewTypes.Account_Contact
                ? localCss.rowContainerAccount
                : localCss.rowContainer
            }
          >
            {overviewType === OverviewTypes.Contact ||
            overviewType === OverviewTypes.Account_Contact ||
            ...
            overviewType === OverviewTypes.CallList.SubContact ? (
              ...
              <div className={localCss.column}>
                ...
                <Button
                  onClick={(e) => this._addCompanyCallList(e)}
                  className={cx(localCss.addButtonAccount, localCss.addButton)}
                >
            ...
            {overviewType === OverviewTypes.Account || overviewType === OverviewTypes.CallList.SubAccount ? (
              ...
              <div className={localCss.column}>
                ...
                <Button
                  onClick={(e) => this._addContactCallList(e)}
                  className={cx(localCss.addButtonAccount, localCss.addButton)}
                >
