...
export const SetLostCandidateModal = ({
  visible,
  overviewType,
  clearHighlight,
  candidateId,
  ...
  return (
    <ModalCommon
      ...
      size="tiny"
    >
      <p>{_l`Do you really want to set this candidate as no?`}</p>
    </ModalCommon>
  );
};

const mapStateToProps = (state, { overviewType }) => {
  const visible = isHighlightAction(state, overviewType, 'setLostCandidate');
...
export default connect(mapStateToProps, mapDispatchToProps)(SetLostCandidateModal);
