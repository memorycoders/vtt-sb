...
import { extractParticipant, participantSchema } from '../User/Participant/participant.schema';
...
const organisationArray = new schema.Array(organisationSchema);

export const organisationList = new schema.Object({
